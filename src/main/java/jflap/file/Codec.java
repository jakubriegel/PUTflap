...
/**
 * This object is both an encoder and decoder, and is useful as a jflap.file filter.
 */

public abstract class Codec extends FileFilter implements Encoder, Decoder {
	/**
	 * Whether the given jflap.file is accepted by the codec. This method is
	 * implemented to, by default, always return true.
	 * 
	 * @param f
	 *            the jflap.file to check for acceptance
	 ...
	 * @param structure
	 *            the structure saved at the jflap.file with that name
