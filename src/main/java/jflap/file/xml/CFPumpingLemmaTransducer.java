 ...
 * {@link jflap.pumping.ContextFreePumpingLemma} objects.
 * 
 * @author Jinghui Lim
...
public class CFPumpingLemmaTransducer extends PumpingLemmaTransducer 
{
     ...
     */
    public static String TYPE = "context-free jflap.pumping lemma";
    /**
    ...
    public Serializable fromDOM(Document document) 
    {
         ...
         * when add case is called, the jflap.pumping lemma chooses the decomposition
