...
import java.util.*;
/**
 * This transducer is the codec for {@link jflap.grammar.lsystem.LSystem} objects.
 * 
...
public class LSystemTransducer extends AbstractTransducer {
	...
	/**
	 * Reads the rewriting rules from the DOM and returns it as a jflap.grammar.
	 * 
	 * @param document
	 *            the DOM document to read rewriting rules from
	 * @return the jflap.grammar that holds these results
	 */
	 ...
	 * @return the {@link jflap.grammar.lsystem.LSystem} instance
	 */
