 ...
 * {@link jflap.pumping.PumpingLemma} objects.
 * 
 * @author Jinghui Lim
...
{
    /**
     * The tag for the name of the jflap.pumping lemma.
     */
    ...
    /**
     * The tag for the <i>m</i> value of the jflap.pumping lemma.
     */
    public static String M_NAME = "m";
    /**
     * The tag for the <i>w</i> value of the jflap.pumping lemma.
     */
    public static String W_NAME = "w";
    /**
     * The tag for the <i>i</i> value of the jflap.pumping lemma.
     */
     ...
     */
    public static String COMMENT_M = "The user's read of m.";
    /**
