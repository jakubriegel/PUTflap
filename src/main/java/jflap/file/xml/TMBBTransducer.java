...
import jflap.automata.turing.TMTransition;
 ...
 * {@link jflap.automata.turing.TuringMachineBuildingBlocks} objects.
 * 
...
public class TMBBTransducer extends AutomatonTransducer {
	/**
	 * Creates and returns an empty Turing machine building blocks.
	 * 
	 * @param document
	 *            the DOM document that is being read
	 * @return an empty Turing machine building blocks
	 */
	 ...
	 * {@link jflap.file.xml.AutomatonTransducer#toDOM} to produce the DOM, and also
