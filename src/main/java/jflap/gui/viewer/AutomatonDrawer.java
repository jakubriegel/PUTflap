...
package jflap.gui.viewer;

import jflap.automata.Automaton;
import jflap.automata.Note;
import jflap.automata.State;
import jflap.automata.Transition;
import jflap.automata.event.AutomataStateEvent;
import jflap.automata.event.AutomataStateListener;
...
//			System.out.println("Using cache");
		...
		ArrayList<Note> notes = getAutomaton().getNotes();
