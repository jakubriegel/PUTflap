...
import jflap.gui.grammar.transform.LambdaPane;
import jflap.gui.grammar.transform.UnitPane;
import jflap.gui.grammar.transform.UselessPane;
...
public class GrammarTransformAction extends GrammarAction {
	...
	public static void hypothesizeChomsky(GrammarEnvironment env, Grammar g) {
		...
		env.add(cp, "Chomsky AutomatonConverter", new CriticalTag() {
		});
		env.setActive(cp);
	}
