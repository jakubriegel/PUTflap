...
import jflap.automata.event.AutomataTransitionEvent;
import jflap.automata.event.AutomataTransitionListener;
import jflap.grammar.Grammar;
import jflap.grammar.Production;
import jflap.gui.event.SelectionEvent;
import jflap.gui.event.SelectionListener;
 ...
 * @see jflap.gui.grammar.GrammarView
 * @see jflap.gui.viewer.SelectionDrawer
 * 
...
class ConvertController {
	...
	public void export() {
		...
		jflap.gui.environment.FrameFactory.createFrame(toExport);
	}
