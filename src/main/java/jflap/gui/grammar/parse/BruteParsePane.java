...
import jflap.grammar.parse.BruteParser;
import jflap.grammar.parse.BruteParserEvent;
import jflap.grammar.parse.BruteParserListener;
...
public class BruteParsePane extends ParsePane {
	...
	protected JPanel initInputPanel() {
		...
		c.weightx = 0.0;
		//JLabel read = new JLabel("Input");
		//read.setPreferredSize(inputField.getSize());
