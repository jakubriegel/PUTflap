...
import jflap.file.Encoder;
import jflap.gui.action.MultipleSimulateAction.MultiplePane;
import jflap.gui.environment.tag.EditorTag;
import jflap.gui.environment.tag.Satisfier;
 ...
 * 
 * @see jflap.gui.environment.EnvironmentFrame
 * @see jflap.gui.environment.tag
 * 
...
public abstract class Environment extends JPanel {
	...
	public void add(Component component, String name, Tag tags) {
		...
		if (tags instanceof jflap.gui.environment.tag.CriticalTag) {
			criticalObjects++;
	...
	public void remove(Component component) {
		...
		// Takes care of the deactivation of EditorTag tagged
		// components in the event that such action is appropriate.
		if (tag instanceof jflap.gui.environment.tag.CriticalTag) {
			criticalObjects--;
