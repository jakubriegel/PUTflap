 ...
 * on how to paint itself on a {@link jflap.gui.pumping.Canvas}.
 * 
 * @author Jinghui Lim
 * @see jflap.gui.pumping.Canvas
 *
 */
public class Text 
{
    ...
    /**
     * Contructs a <code>Text</code> object with an read string.
     * 
    ...
    /**
     * Constructs a <code>Text</code> object with an read string and
     * a position.
     * 
     ...
     * @return a <code>Text</code> object that is a lable for the read
     */
