...
/**
 * A <code>Canvas</code> is an area where strings, {@link jflap.gui.pumping.Text},
 * are animated as {@link jflap.gui.pumping.MovingText} and will move
 * to construct the pumped string. 
 * 
 * @author Jinghui Lim
 * @see jflap.gui.pumping.PumpingLemmaInputPane
 *
 */
public class Canvas extends JPanel 
{
    ...
    /**
     * Resets the canvas for new read.
     *
     */
    public void reset()
    {
