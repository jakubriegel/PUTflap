...
public abstract class PumpingLemmaInputPane extends JPanel 
{
    ...
    /**
     * Initializes and returns the right panel, a {@link jflap.gui.pumping.CasePanel}
    ...
    /**
     * Sets the decomposition in the read pane and sets the decomposition and
    ...
    /**
     * Sets the decomposition in this read pane. It changes the values in
     ...
     * for read string "<i>aaabbb</i>" it produces
     * "<i>a</i><sup>3</sup><i>b</i><sup>3</sup>".
     *  
     * @param s the string to be converted
     * @return a string with HTML tags that reprents read string <code>s</code>
     */
    ...
    /**
     * This updates all the fields of the read pane to display the information
