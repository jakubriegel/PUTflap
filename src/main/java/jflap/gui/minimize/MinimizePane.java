...
public class MinimizePane extends JPanel {
	...
	public AutomatonPane initAutomatonPane() {
		...
		jflap.gui.SuperMouseAdapter a = new ArrowMinimizeTool(apane, automatonDrawer);
	...
	public TreePanel initTreePane() {
		...
		jflap.gui.SuperMouseAdapter a = new jflap.gui.SuperMouseAdapter() {
	 ...
	 * transitions.
	 */
	private class ArrowMinimizeTool extends jflap.gui.editor.ArrowNontransitionTool {
		/**
