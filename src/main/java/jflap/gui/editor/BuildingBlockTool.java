...
public class BuildingBlockTool extends Tool {
	 ...
	 * 
	 * @see jflap.gui.editor.TransitionCreator#creatorForAutomaton
	 */
	public BuildingBlockTool(AutomatonPane view, AutomatonDrawer drawer) {
		super(view, drawer);
	}
	...
	protected Icon getIcon() {
		java.net.URL url = getClass().getResource("/jflap/ICON/blocks.gif");
...
//MERLIN MERLIN MERLIN MERLIN MERLIN//
		...
		block = ((TuringMachineBuildingBlocks) getAutomaton()).createBlock(event.getPoint());
		getView().repaint();
	}
