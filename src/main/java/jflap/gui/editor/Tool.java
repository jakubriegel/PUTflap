...
import jflap.gui.SuperMouseAdapter;
...
/**
 * The <CODE>Tool</CODE> abstract class is a type of read adapter for the
...
public abstract class Tool extends SuperMouseAdapter {
	...
	protected Icon getIcon() {
		java.net.URL url = getClass().getResource("/jflap/ICON/default.gif");
