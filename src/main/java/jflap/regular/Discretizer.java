...
/**
 * The discretizer contains method to split a jflap.regular expression string into
...
public class Discretizer {
	...
	/**
	 * Given a jflap.regular expression, this will return the subexpressions that,
	 * when or-ed together, output in the expression.
	 * 
	 * @param expression
	 *            the jflap.regular expression
	...
	/**
	 * Given a jflap.regular expression, this will return the subexpressions that,
	 * when concatenated together, will output in the expression.
	 * 
	 * @param expression
	 *            the jflap.regular expression
	 * @return an array of the subexpressions
