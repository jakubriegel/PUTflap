...
/**
 * This event should be distributed when a jflap.regular expression object changes.
 * 
...
public class ExpressionChangeEvent extends EventObject {
	 ...
	 * @param old
	 *            the string representing the old jflap.regular expression
	 */
	...
	/**
	 * Returns the jflap.regular expression that was changed.
	 * 
	 * @return the jflap.regular expression that was changed
	 */
