...
//       //END MERLIN MERLIN MERLIN MERLIN MERLIN// //this code is only for show, it should be moved into a setting with a better UI before release//
	 ...
	 * configuration of the TM, before any read has been processed. This
...
outer:  while (true){
            ...
            for (int i = 0; i < trans.length; i++){
                ...
                //tilda means to read nothing or write nothing, and it seems to be explicitly written for turing machines, rather differently from other jflap.automata
            }
