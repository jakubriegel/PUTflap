 ...
 * 
 * @see jflap.automata.turing.TuringMachine
 * 
...
public class TMTransition extends Transition {
	...
	//added for turing to jflap.grammar conversion
	private int tapes;
	...
	/**
	 * Returns the read to read for the given tape.
	 * 
	 * @param tape
	...
	/**
	 * Sets the read to read for a given tape.
	 * 
	 * @param stringToRead
	 *            the read to read for a given tape
	 * @param tape
	 *            the tape index
	 */
	 ...
	 * 
	 * @return the description, in this case, the read to read from the tape,
