...
public class TuringMachineBuildingBlocks extends TuringMachine {
	/**
	 * 
	 */
	 ...
	 */
	public TuringMachineBuildingBlocks() {
		this(1);
	}
	 ...
	 */
	public TuringMachineBuildingBlocks(int tapes) {
		super();
		this.tapes = tapes;
	}
	 ...
	 * accept.
	 * 
	 * @return the <CODE>Class</CODE> object for <CODE>jflap.automata.tm.TMTransition</CODE>
	 */
	protected Class getTransitionClass() {
		return jflap.automata.turing.TMTransition.class;
	}
	...
	public Object clone() {
        ...
        TuringMachineBuildingBlocks a = new TuringMachineBuildingBlocks(this.tapes());
...
//				a.addTransition(ts[i].copy(from, to));
  ...
  /**
   * Reads the automaton in from a jflap.file.
   */
...
//				this);
        assert serial instanceof TuringMachineBuildingBlocks;
        TuringMachineBuildingBlocks tm = (TuringMachineBuildingBlocks) serial;
	...
	public static void become(TuringMachineBuildingBlocks dest, TuringMachineBuildingBlocks src){
...
//		EDebug.print("finished");
	...
	public Map<String, TuringMachineBuildingBlocks> getTMBBBlockMap(){
        Map<String, TuringMachineBuildingBlocks> ret = new HashMap<String, TuringMachineBuildingBlocks>();
        ...
        for (TMState s: statesSet) //that's right, EVERY state in TM has an inner Auto, even if that inner auto might be empty.
            ret.put(s.getInternalName(), (TuringMachineBuildingBlocks) s.getInnerTM());
