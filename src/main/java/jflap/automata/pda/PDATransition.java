 ...
 * additional fields for the label (read to read), the string to pop off the
 * stack, and the string to push on the stack.
 * 
 * @see jflap.automata.pda.PushdownAutomaton
 * 
...
public class PDATransition extends Transition {
	...
	/**
	 * Returns the read to read portion of the transition label for this
	 * transition.
	 */
	...
	/**
	 * Sets the read to read portion of the transition label for this
	 * transition.
	 * 
	 * @param inputToRead
	 *            the read to read portion of the transition label.
	 */
	protected void setInputToRead(String inputToRead) {
		/*
		 * if (!jflap.automata.StringChecker.isAlphanumeric(inputToRead)) throw new
	...
	protected void setStringToPop(String stringToPop) {
		/*
		 * if (!jflap.automata.StringChecker.isAlphanumeric(stringToPop)) throw new
	...
	protected void setStringToPush(String stringToPush) {
		/*
		 * if (!jflap.automata.StringChecker.isAlphanumeric(stringToPush)) throw new
	 ...
	 * 
	 * @return the description, in this case, the read to read, the string to
	 ...
	 * string representation for a jflap.regular transition object, with the
