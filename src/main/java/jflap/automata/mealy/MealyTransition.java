...
public class MealyTransition extends Transition 
{
     ...
     * as the string representation for a jflap.regular transition object with
     ...
     * if they satisfy jflap.automata.Transition.equals(Object) and have the same
     * label and output.
     * 
     * @see jflap.automata.Transition#equals(Object)
