...
/**
 * The jflap.automata object is the root class for the representation of all forms of
 * jflap.automata, including FA, PDA, and Turing machines. This object does NOT
...
//			copyRelevantDataForBlocks(nstate, state, a);
		...
		while (it.hasNext()) {
			...
			for (int i = 0; i < ts.length; i++) {
                ...
                Transition toBeAdded = (Transition) ts[i].clone(); //call clone instead of copy so that the jflap.gui stuff can get appropriately updated
...
//				dest.addTransition(ts[i].copy(from, to));
	...
	/**
	 * Adds a new state to this jflap.automata. Clients should use the <CODE>createState</CODE>
	 * method instead.
	 * 
	 * @param state
	 *            the state to add
...
//		}
	 ...
	 * initial state. The state specified should already exist in the jflap.automata.
	 * 
	 * @param initialState
	 ...
	 * method simply returns the class object for the abstract class <CODE>jflap.automata.Transition</CODE>.
	 * 
	 * @see #addTransition
	 * @see jflap.automata.Transition
	...
	protected Class<Transition> getTransitionClass() {
		return jflap.automata.Transition.class;
	}
	...
	/**
	 * Adds a <CODE>AutomataStateListener</CODE> to this jflap.automata.
	 * 
	 * @param listener
	 *            the listener to add
	 */
	...
	/**
	 * Adds a <CODE>AutomataTransitionListener</CODE> to this jflap.automata.
	 * 
	 * @param listener
	 *            the listener to add
	 */
	...
	/**
	 * Adds a <CODE>AutomataNoteListener</CODE> to this jflap.automata.
	 * 
	 * @param listener
	 *            the listener to add
	 */
	...
	/**
	 * Gives an jflap.automata state change event to all state listeners.
	 * 
	 * @param event
	...
	/**
	 * Removes a <CODE>AutomataStateListener</CODE> from this jflap.automata.
	 * 
	 * @param listener
	...
	/**
	 * Removes a <CODE>AutomataTransitionListener</CODE> from this jflap.automata.
	 * 
	 * @param listener
	 *            the listener to remove
	 */
	...
	/**
	 * Removes a <CODE>AutomataNoteListener</CODE> from this jflap.automata.
	 * 
	 * @param listener
	 *            the listener to remove
	 */
	...
	/**
	 * Gives an jflap.automata transition change event to all transition listeners.
	 * 
	 * @param event
	 *            the event to distribute
	 */
	...
	/**
	 * Gives an jflap.automata note change event to all state listeners.
	 * 
	 * @param event
	 *            the event to distribute
	 */
...
//        EDebug.print(ret);
	...
	// defintion of jflap.automata, but stuff that makes it at least
