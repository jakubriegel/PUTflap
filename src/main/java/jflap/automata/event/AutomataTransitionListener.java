...
/**
 * An interface that those interested in changes in transitions in an jflap.automata
 * should listen to.
 * 
 * @see jflap.automata.event.AutomataTransitionEvent
 * @see jflap.automata.Automaton#addTransitionListener
 */
