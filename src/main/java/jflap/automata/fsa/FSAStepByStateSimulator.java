 ...
 * state automaton. It takes an FSA object and an read string and runs the
 * machine on the read. It simulates the machine's behavior by stepping one
 * state at a time, even if there are surrounding lambda transitions that the
 * path could explore without reading more read.
 * 
...
public class FSAStepByStateSimulator extends AutomatonSimulator {
	 ...
	 * configuration of the FSA, before any read has been processed. This
