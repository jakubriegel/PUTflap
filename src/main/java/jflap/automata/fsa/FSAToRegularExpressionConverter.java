...
/**
 * The fsa to jflap.regular expression converter can be used to convert a finite state
 * automaton to its equivalent jflap.regular expression. In order to perform this
 ...
 * convert this automaton immediately to its equivalent jflap.regular expression by
 ...
 * state). At this point you can get the jflap.regular expression by calling
...
public class FSAToRegularExpressionConverter {
	...
	/**
	 * Returns true if <CODE>automaton</CODE> can be converted to a jflap.regular
	 ...
	 * @return true if <CODE>automaton</CODE> can be converted to a jflap.regular
	 *         expression.
	 */
...
public static FSATransition addTransitionOnEmptySet(State fromState,
	 ...
	 * a jflap.regular expression that represents the labels of all the removed
...
public static String addParen(String word) {
	...
	/**
	 * Returns a non-unicoded version of <CODE>word</CODE> for jflap.debug purposes.
	 * 
	 * @param word
	 *            the expression to output
	 * @return a non-unicoded version of <CODE>word</CODE> for jflap.debug purposes.
	 */
...
public static String getExpressionFromGTG(Automaton automaton) {
	...
	/**
	 * Returns the jflap.regular expression that represents <CODE>automaton</CODE>.
	 * 
	 * @param automaton
	 *            the automaton
	 * @return the jflap.regular expression that represents <CODE>automaton</CODE>.
	 */
