 ...
 * a jflap.regular Finite State Automaton.
 * 
...
public class FiniteStateAutomaton extends Automaton {
	 ...
	 * accept.
	 * 
	 * @return the <CODE>Class</CODE> object for <CODE>jflap.automata.fsa.FSATransition</CODE>
	 */
	protected Class getTransitionClass() {
		return jflap.automata.fsa.FSATransition.class;
	}
}
