...
public class Minimizer {
	 ...
	 *         <CODE>terminal</CODE>.
	 */
	public ArrayList<State[]> getGroupsFromGroupOnTerminal(State[] group,
	 ...
	 */
	public ArrayList<State[]> splitOnTerminal(State[] group, String terminal,
			Automaton automaton, DefaultTreeModel tree) {
	 ...
	 *            the tree
	 */
	public void addChildrenToParent(ArrayList<State[]> children,
	 ...
	 *            the dfa being minimized.
	 */
	public ArrayList<Transition> getTransitionsForState(State state, Automaton minDfa,
