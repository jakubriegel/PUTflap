...
/**
 * This class represents a configuration of an automaton for simulation of read
 * on an automaton (i.e. the state the automaton is currently in, the
 * unprocessed read, and the contents of the tapes/stack if applicable). A
 ...
 * 
 * @see jflap.automata.AutomatonSimulator
 * 
...
public abstract class Configuration implements Cloneable {
	 ...
	 * 
	 * @see jflap.automata.AutomatonSimulator#stepConfiguration
