 ...
 * for each class of {@link jflap.pumping.PumpingLemma}.
 * 
 * @author Jinghui Lim
 *
 */
public abstract class Case 
{
    ...
    /**
     * Previously entered user read. It is <code>null</code> if the
     * user has not entered any read.
     */
    protected int[] userInput;
    
    /**
     * Constructs a new case with no user read.
     *
     */    
     ...
     * {@link jflap.pumping.Case}, this method should have access to <i>m</i>
     * of the {@link jflap.pumping.PumpingLemma} either as an internal
    ...
    /**
     * Resets the case, clearing user read and <i>i</i>.
     *
     */
    public void reset()
    {
