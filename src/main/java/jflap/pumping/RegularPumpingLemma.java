...
public abstract class RegularPumpingLemma extends PumpingLemma implements Serializable, Cloneable
{
     ...
     * read array. That is, |<i>x</i>| = <code>decomposition[0]</code>,
    ...
    {
        /*
         * This shouldn't be called for most jflap.regular jflap.pumping lemmas.
         */
        /*
     ...
     * In most jflap.regular jflap.pumping lemmas, there is only one case and
    ...
    {
        /*
         * For most jflap.regular jflap.pumping lemmas, there is only one case so we
    ...
    /**
     * Chooses a random jflap.regular decomposition.
     */
