...
/**
 * The jflap.regular jflap.pumping lemma for <i>L</i> = {<i>b<sup>5</sup>w</i> : <i>w</i> &#8712;
...
public class B5Wmod extends RegularPumpingLemma {
	...
	public void setDescription()
    {
    	...
    	explanation = "Because this is a jflap.regular language, a valid decomposition exists.  If <i>m</i> " + GREATER_OR_EQ +" 8, " +
