...
/**
 * The jflap.regular jflap.pumping lemma for <i>L</i> = {<i>a<sup>n</sup></i>
 * : <i>n</i> is even}.
 * 
...
public class AnEven extends RegularPumpingLemma 
{
    ...
    public void setDescription()
    {
    	...
    	explanation = "Because this is a jflap.regular language, a valid decomposition exists.  If <i>m</i> " + GREATER_OR_EQ +" 2, " +
