 ...
 * to guide the user through a jflap.pumping lemma proof.
 * 
...
public abstract class PumpingLemma implements Serializable
{
    ...
    /**
     * The <i>m</i> value used by this jflap.pumping lemma.
     */
    protected int m;
    /**
     * The <i>w</i> value used by this jflap.pumping lemma.
     */
    protected String w;
    /**
     * The <i>w</i> value used by this jflap.pumping lemma.
     ...
     */
    protected ArrayList<Object> myAllCases;
    /**
     ...
     */
    protected ArrayList<Object> myDoneCases;
    /**
    ...
    public PumpingLemma()
    {
        myDoneCases = new ArrayList<Object>();
        myAllCases = new ArrayList<Object>();
    ...
    /**
     * Returns a string title of the jflap.pumping lemma.
     * 
     ...
     * decomposition in the corresponding space of the read array,
    ...
    /**
     * Sets the <i>i</i> this instance of the jflap.pumping lemma uses.
     * 
    ...
    /**
     * Initializes all the possible cases for this jflap.pumping lemma.
     *
     */
    ...
    /**
     * Returns the list of done {@link jflap.pumping.Case}s.
     * 
     * @return the list of done <code>Case</code>s
     */
    public ArrayList<Object> getDoneCases()
    {
        return myDoneCases;
    }
