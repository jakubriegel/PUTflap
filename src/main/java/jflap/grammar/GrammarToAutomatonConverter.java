...
/**
 * The jflap.grammar to automaton converter can be used to convert a jflap.grammar to an
 * equivalent automaton. This is an abstract class that is extended by
 * converters for specific types of grammars (e.g. jflap.regular) To utilize this
 * converter, you must determine what type of jflap.grammar you are trying to convert
 ...
 * getTransitionsForProduction method for each production in the jflap.grammar and add
...
public abstract class GrammarToAutomatonConverter {
	...
	/**
	 * Returns an automaton that is equivalent to <CODE>jflap.grammar</CODE> in that
	 * they will accept the same language.
	 * 
	 * @param grammar
	 *            the jflap.grammar
	 * @return an automaton that is equivalent to <CODE>jflap.grammar</CODE> in that
	 *         they will accept the same language.
	 */
