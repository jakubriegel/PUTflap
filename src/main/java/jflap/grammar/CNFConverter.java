...
public class CNFConverter {
	...
	/** The jflap.grammar we're converting. */
	private Grammar grammar;

	/**
	 * This is not a directory of productions in the jflap.grammar as such, but rather
