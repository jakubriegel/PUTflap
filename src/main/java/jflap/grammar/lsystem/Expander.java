...
public class Expander {
	...
	/**
	 * Returns the expansion at a given level of recursion. An read of 0 will
	...
	private class Context {
		...
		/**
		 * Given an read list, checks to see if it partially matches with the
		 * center of the read list and the center of this list.
		 * 
		 * @param list
		...
		/** The output of finding a matching. */
