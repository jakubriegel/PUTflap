...
public class LLParseTable extends AbstractTableModel implements Serializable,
	...
	/**
	 * Instantiates a new <CODE>LLParseTable</CODE> for a given jflap.grammar.
	 * 
	 * @param grammar
	 *            the jflap.grammar to create the table for
	 */
	 ...
	 *             (or $) respectively in the jflap.grammar
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if the variable is not a variable in the jflap.grammar
	 */
	...
	/** The variables in the jflap.grammar, each corresponding to a row. */
