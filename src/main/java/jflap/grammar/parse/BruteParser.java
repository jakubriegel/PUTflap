 ...
 * force parse of a jflap.grammar.
 * 
...
public abstract class BruteParser {
	 ...
	 * {@link #init} with the jflap.grammar and target string.
	 */
	 ...
	 * 
	 * @param grammar
	 *            the jflap.grammar to get a brute force parser for
	 * @param target
	 *            the target string
	 */
	 ...
	 * derivation could eventually output in our target. Note that returning
	 * <CODE>true</CODE> does not mean that this derivation can actually
	 * output in the target, just that it has not been firmly ruled out. This
