...
public class LRParseTable extends AbstractTableModel implements Serializable,
	 ...
	 * @param fsa
	 *            the goto graph for the jflap.grammar
	 */
	...
	/**
	 * This sets the table value for a state ID and a jflap.grammar symbol.
	 * 
	 * @param value
	 ...
	 *            the state ID
	 * @param symbol
	 *            the jflap.grammar symbol
	 * @throws IllegalArgumentException
	 *             if symbol is not in the jflap.grammar
	 */
	...
	/**
	 * This will return the value for a given state ID and jflap.grammar symbol.
	 * 
	 * @param id
	 *            the state ID
	 * @param symbol
	...
	/**
	 * Returns the column for a particular jflap.grammar symbol.
	 * 
	 * @param symbol
	 *            the jflap.grammar symbol
	 * @return the column index of the column corresponding to that jflap.grammar
	 *         symbol
	 * @throws IllegalArgumentException
	 *             if symbol is not in the jflap.grammar
	 */
	 ...
	 * 
	 * @param value
	 *            the value that was read into the table
	 * @param column
	 *            the column that we're trying to edit
	 * @return an improved form of the read, or <CODE>null</CODE> if, for
	...
	private String getContentDescription(String entry) {
		...
		case 'a':
			return "Accept";
		case 's':
			return "Shift current read and state " + entry.substring(1)
					+ " to stack";
		case 'r':
	...
	/** The terminals of the jflap.grammar. */
	private String[] variables;

	/** The nonterminals of the jflap.grammar, including $ at the end. */
	private String[] terminals;

	/** The entries of the table. */
	private String[][] entries;

	/** The jflap.grammar for the parse table. */
	private Grammar grammar;

	/** The mapping of jflap.grammar symbols to an Integer indicating the column. */
