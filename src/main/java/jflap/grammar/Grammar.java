...
/**
 * The jflap.grammar object is the root class for the representation of all forms of
 * grammars, including jflap.regular and context-free grammars. This object simply
 * maintains a structure that holds and maintains the data pertinent to the
 * definition of a jflap.grammar.
 * 
...
public abstract class Grammar implements Serializable, Cloneable {
	...
	public Object clone() {
		...
		try {
			...
			System.err.println("Warning: clone of jflap.grammar failed!");
			return null;
		}
	 ...
	 * jflap.grammar. This method by default calls <CODE>checkProduction</CODE> and
	...
	/**
	 * If a production is invalid for the jflap.grammar, this method should throw
	...
	/**
	 * Adds <CODE>production</CODE> to the set of productions in the jflap.grammar.
	 * 
	 * @param production
	...
	public void addProduction(Production production) {
		...
		/** if production already in jflap.grammar. */
	...
	/**
	 * Adds <CODE>productions</CODE> to jflap.grammar by calling addProduction for
	 * each production in array.
	 * 
	 * @param productions
	 *            the set of productions to add to jflap.grammar
	 */
	...
	/**
	 * Returns all productions in the jflap.grammar.
	 * 
	 * @return all productions in the jflap.grammar.
	 */
	...
	/**
	 * Adds <CODE>terminal</CODE> to the set of terminals in the jflap.grammar.
	 * 
	 * @param terminal
	 *            the terminal to add.
	 */
	...
	/**
	 * Removes <CODE>terminal</CODE> from the set of terminals in the jflap.grammar.
	 * 
	 * @param terminal
	...
	/**
	 * Returns all terminals in the jflap.grammar.
	 * 
	 * @return all terminals in the jflap.grammar.
	 */
	...
	/**
	 * Adds <CODE>variable</CODE> to the set of variables in the jflap.grammar.
	 * 
	 * @param variable
	 *            the variable to add.
	 */
	...
	/**
	 * Removes <CODE>variable</CODE> from the set of variables of the jflap.grammar.
	 * 
	 * @param variable
	...
	/**
	 * Returns all variables in the jflap.grammar.
	 * 
	 * @return all variables in the jflap.grammar.
	 */
	...
	/**
	 * Returns a string representation of the jflap.grammar object, listing the four
	 * parts of the definition of a jflap.grammar: the set of variables, the set of
	 * terminals, the start variable, and the set of production rules.
	 * 
	 * @return a string representation of the jflap.grammar object.
	 */
