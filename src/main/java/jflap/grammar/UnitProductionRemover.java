...
/**
 * The Unit Production remover can be used to convert a jflap.grammar to an equivalent
 * jflap.grammar that doesn't have any unit productions (i.e productions of the form
 ...
 * productions from the original jflap.grammar into the new gramamr. 3. adding
 * productions to the new jflap.grammar to replace the unit productions in the
 * original jflap.grammar. Each step can be performed immediately or step by step. You
 ...
 * jflap.grammar to your dependency graph. Then, you actually represent the
 * dependencies of the variables by examining only the unit productions in the
 * jflap.grammar. To get the transition (for the graph) that represents the dependency
 ...
 * do this for every unit production in the jflap.grammar, the dependency graph will
 ...
 * jflap.grammar to see if it is a unit production. So, if the user selects a
 * production from the original jflap.grammar and tries to add it to the new jflap.grammar,
 * you must check (using the ProductionChecker) if the production is a unit
 * production. If not, you can add it to the new jflap.grammar by simply calling
 * addProduction on the jflap.grammar. Once you've added all the Non-unit productions
 * from the original jflap.grammar to the new jflap.grammar, you can finish the conversion
 ...
 * dependencies for each variable in the jflap.grammar by calling getDependencies.
 * Then, for each variable that said variable is dependent on, you need to get
 * all the non-unit productions in the jflap.grammar on that variable (by using a
...
public class UnitProductionRemover {
	...
	/**
	 * Returns the variable dependency graph for the variables in <CODE>jflap.grammar</CODE>.
	 * 
	 * @param grammar
	 *            the jflap.grammar.
	 * @return the variable dependency graph for the variables in <CODE>jflap.grammar</CODE>.
	 */
	...
	/**
	 * Returns all unit productions in <CODE>jflap.grammar</CODE>.
	 * 
	 * @param grammar
	 *            the jflap.grammar.
	 * @return all unit productions in <CODE>jflap.grammar</CODE>.
	 */
	...
	/**
	 * Returns all non-unit productions in <CODE>jflap.grammar</CODE>.
	 * 
	 * @param grammar
	 *            the jflap.grammar
	 * @return all non-unit productions in <CODE>jflap.grammar</CODE>.
	 */
	...
	/**
	 * Adds a state for each variable in <CODE>jflap.grammar</CODE> to <CODE>graph</CODE>.
	 * 
	 * @param graph
	 ...
	 * 
	 * @param oldGrammar
	 *            the original jflap.grammar
	 * @param newGrammar
	 *            the new jflap.grammar
	 * @param graph
	 *            the variable dependency graph of the original jflap.grammar
	 */
	...
	/**
	 * Returns a unit production-less jflap.grammar equivalent to <CODE>jflap.grammar</CODE>.
	 * 
	 * @param grammar
	 *            the jflap.grammar
	 * @param graph
	 *            the variable dependency graph of <CODE>jflap.grammar</CODE>.
	 * @return a unit production-less jflap.grammar equivalent to <CODE>jflap.grammar</CODE>.
	 */
